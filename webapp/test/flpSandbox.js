		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Attendee List",
									"targetURL": "#comspzattendee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comspzattendee-display": {
								"semanticObject": "comspzattendee",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sp.zattendee",
									"url": sap.ui.require.toUrl("com/sp/zattendee")
								}
							}
						}
					}
